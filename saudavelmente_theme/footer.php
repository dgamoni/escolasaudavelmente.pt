		...
		<div  id="under-footer" class="container-fluid">
			<div class="container">
		        <div class="row">
		        	...
		        	<div class="col-md-5 text-md-left"><a href="mailto:escolasaudavelmente@ordemdospsicologos.pt" target="_blank">escolasaudavelmente@ordemdospsicologos.pt</a><br />Ordem dos Psicólogos Portugueses © <?php echo date("Y"); ?> Todos os direitos reservados</div>
