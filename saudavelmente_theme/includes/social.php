			...
			<div class="row "> -->
				<ul class="text-md-left">
				    ...
				    while ( have_rows('gal_social_icon', 'option') ) : the_row();
						...
						<li><a class="social_icon_s_svg2 social_icon_link_google_svg" onclick="deco_soc_sharing_window('https://plus.google.com/share?url=<?php echo $carrent_link;?>', '<?php echo $name; ?>'); return false;" href="#">Share on Google+</a></li>
